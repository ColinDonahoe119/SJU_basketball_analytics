...
# --- Load Data ---
df = pd.read_csv(r"C:\Users\colin\OneDrive - Saint Joseph's University\Documents\SJU_Basketball_Analytics\season_stats.csv")
team_df = pd.read_csv(r"C:\Users\colin\OneDrive - Saint Joseph's University\Documents\SJU_Basketball_Analytics\team_stats.csv")
...
previous_stats = ["ortg", "drtg", "ts", "usg", "porpag", "adj_oe", "adj_de", "bpm", "adj_o", "adj_d", "barthag", "oreb_rate", "ast_to"]
...
combined_df["change_ast_to"]   = combined_df["ast_to"]   - combined_df["previous_ast_to"]
