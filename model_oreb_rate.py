...
NUMERICAL = [
    ...
    'previous_oreb_rate', 'previous_bpm', 'previous_ortg', 'previous_drtg',
...
plt.title('Top 15 Feature Importances — change_oreb_rate Model')
...
plt.xlabel('Actual change_oreb_rate')
plt.ylabel('Predicted change_oreb_rate')
plt.title('Actual vs Predicted change_oreb_rate')
plt.legend()
plt.tight_layout()
plt.show()
